    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.disclaimer}>
          동네콕은 통신판매중개자이며, 통신판매의 당사자가 아닙니다. 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령 및 동네쿡의 약관에 따라 상품, 상품정보, 거래에 관한 책임은 개별 판매자에게
          귀속하고, 동네콕은 원칙적으로 회원간 거래에 대하여 책임을 지지 않습니다. 다만, 동네콕이 직접 판매하는 상품에 대한 책임은 동네콕에게 귀속합니다.
        </div>
